...
The motifs were downloaded from the [**Anised**](https://www.aniseed.cnrs.fr/aniseed/)
...
The first file contains the best PFM of each TF, the second file contains the annotation
of the TFs (IDs, name, family, interprot ID).
